...
apartment_schema = DataFrameSchema({
    ...
    "floor_total": Column(int, Check.in_range(1, 100), nullable=True),
    "latitude": Column(float, Check.in_range(54.5, 57.0), nullable=True),
    "longitude": Column(float, Check.in_range(36.0, 39.5), nullable=True)
})
